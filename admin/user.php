	...
	<?php
		if(isset($_SESSION['idadmin']))
		{
			if($_POST['sua'])
			{
				...
				if($checkbox=='')
				{
					echo '<script type="text/javascript"> alert("Please select users!"); </script>';
				}
				else
				{
			...
			if($_POST['no'])
			{
				...
				else
				{
					...
					{
						$a=$row['username'];}
						$sql = mysql_query("DELETE FROM user WHERE id IN($del_id)");
						echo 'Successfully deleted user: <b>'.$a.' </b>';
			...
			<div class="span12">
				...
				<div class="block-fluid table-sorting">
					...
					<table width="348" border="0">
					  <tr>
						<td width="127"><input class="btn btn-large" type="submit" value="Edit" onClick="return confirm('Edit user?');" name="sua" ></td>
						<td width="12">&nbsp;</td>
						<td width="187"><input class="btn btn-large" type="submit" value="Delete" onClick="return confirm('Delete user ?');" name="no" ></td>
					  </tr>
					</table>
					<p>&nbsp; </p>
					<div class="clear"></div>	
